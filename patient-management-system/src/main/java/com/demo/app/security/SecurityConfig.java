...
//				.antMatchers("/auth/**","/users/signu"
//						+ "p", "/users/login","/swagger*/**","/v*/api-docs/**")
//				.permitAll()
//				// only required for JS clnts (react / angular) : for the pre flight requests
//				.antMatchers(HttpMethod.OPTIONS).permitAll().antMatchers().hasRole("PLAYER")
//				.antMatchers("teams/**","players/**/**","/matches/**").hasRole("ADMIN").anyRequest().authenticated().and()
